\begin{enumerate}[label=\alph*.]
	...
	%%%%%%%%% a %%%%%%%%%%
	%%%%%%%%%%%%%%%%%%%%%%
	\item On Figure \ref{fig:stratForm} we can find the extensive form.
	...
	\item The normal representation can be found on Table \ref{tab:normRep}.
	      ...
	      %%%%%%%%% c %%%%%%%%%%
	      %%%%%%%%%%%%%%%%%%%%%%
	\item Now let us eliminate the weakly dominated strategies. Of course, all the strongly dominated strategies are also weakly dominated.

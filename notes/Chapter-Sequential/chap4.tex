...
\begin{enumerate}
\item $P(X_10 | \tau) = (X_{10} | X_0, \tau) = (1-\alpha)  (1-\gamma) (\beta)$, which is simply the probability of occurrence of the path from $X_0$ to $X_{10}$.
...
The multi-agent representation of the card game of Example \ref{ch4:ex:cardGameMultiAgent} is given by
 \begin{center}
 \begin{tabular}{l|cc}
 & 1.a: Raise & 1.a: Fold \\
\begin{tabular}{l}
